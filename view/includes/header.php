...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+Thai:wght@200;300;400&display=swap" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion navMenu" style="background-image:url(public/img/backgroud.jpg);opacity:0.95;" id="accordionSidebar">
